...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    public void saveMenu(MenuAddDTO menuAddDTO) {
        ...
        SysPermission permission = toPermission(menuAddDTO);
    ...
    public void editMenu(MenuUpdateDTO menuUpdateDTO) {
        ...
        checkPermissionKeyUnique(finalPermissionKey, menuUpdateDTO.getId());
        updatePermission(menuUpdateDTO, dbPermission);
    ...
    private SysPermission toPermission(MenuAddDTO dto) {
        SysPermission permission = new SysPermission();
        permission.setParentId(dto.getParentId());
        permission.setName(dto.getName());
        permission.setMenuPath(dto.getMenuPath());
        ...
        permission.setIsCache(dto.getIsCache());
        permission.setIsFrame(dto.getIsFrame());
        permission.setRemark(dto.getRemark());
        return permission;
    }

    private void updatePermission(MenuUpdateDTO dto, SysPermission permission) {
